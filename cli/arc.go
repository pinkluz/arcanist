...
func init() {
	...
	base.cmd = &cobra.Command{
		...
		Long: `arc is a git workflow management tool that is based on the arcanist tooling that
		was build by epriestly for Phabricator. Arc is a patch based workflow tool that focuses on creating a
		readable commit log.`,
